...
from .certificates_api import router as certificates_router # Added
...
v1_router.include_router(certificates_router, prefix="", dependencies=[DependPermisson]) # Added, prefix is already in certificates_router
